...
podstawowka = Button(root, text = 'Szkoła Podstawowa', width=buttonwidth, height=buttonheight, font = "Arial 20").place(x= button1x, y=button1y)
liceum = Button(root, text = 'Liceum', width=buttonwidth, height=buttonheight, font = "Arial 20").place(x= button2x, y=button2y)
