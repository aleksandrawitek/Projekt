...
var1 = IntVar()
reszta = Label(root, text = "Reszta", background='papaya whip', font = "Arial 30 ", fg = 'black').place(x= 1.6*odpx, y=odpy)
poletekstowe1 = Entry(root, bd = 10, textvariable=var1).place(x= 2*polex, y=odpy)
sprawdzenie = Button(root, text = 'Enter', width=int(0.2*buttonwidth), height=buttonheight, font = "Arial 20", command = sprawdz).place(x= 1.7*sprx, y=odpy)
