...
tekst = Label(root, text = 'Wybierz klasę:', font = "Arial 30 ", width = okno_szer, height=4,background='navajo white', fg = 'papaya whip', anchor = CENTER)
tekst.pack()
...
klasa4 = Button(root, text = 'Klasa 4', width=buttonwidth, height=buttonheight, font = "Arial 20", command = open4).place(x= buttonx, y=button1y)
klasa5 = Button(root, text = 'Klasa 5', width=buttonwidth, height=buttonheight, font = "Arial 20").place(x= buttonx, y=button2y)
klasa6 = Button(root, text = 'Klasa 6', width=buttonwidth, height=buttonheight, font = "Arial 20").place(x= buttonx, y=button3y)
klasa7 = Button(root, text = 'Klasa 7', width=buttonwidth, height=buttonheight, font = "Arial 20").place(x= buttonx, y=button4y)
klasa8 = Button(root, text = 'Klasa 8', width=buttonwidth, height=buttonheight, font = "Arial 20").place(x= buttonx, y=button5y)
