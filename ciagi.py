...
klasa1 = Button(root, text = 'Ciąg arytmetyczny', width=buttonwidth, height=buttonheight, font = "Arial 20", command = openarytmetyczny).place(x= buttonx, y=button1y)
klasa2 = Button(root, text = 'Ciąg geometryczny', width=buttonwidth, height=buttonheight, font = "Arial 20", command = opengeometryczny).place(x= buttonx, y=button2y)
